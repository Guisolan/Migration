...
class sale_order_line(models.Model):
    ...
    layout_type = fields.Selection(LAYOUTS_LIST, 'Layout type', required=True, select=True, default=lambda *a: 'article')
    rel_subtotal = fields.Float(compute='_sub_total', string='Rel. Sub-total', digits_compute= dp.get_precision('Account'))
